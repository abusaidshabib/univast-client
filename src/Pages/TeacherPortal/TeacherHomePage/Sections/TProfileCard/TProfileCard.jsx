...
const TProfileCard = () => {
  ...
  if (isSuccess) {
    ...
    const { departmentName, publication, courses_taught } = teacherData;
    const {
      address,
      firstName,
      lastName,
      ...
      <div className="col-span-1 p-3 bg-white rounded-lg">
        <div className="profile-card relative">
          ...
          <div className="text-center pt-16">
            ...
            <p>{email}</p>
            <p>
              {address?.permanent_address?.permanent_city},{" "}
              {address?.permanent_address?.permanent_country}
            </p>
            <div>
              <div className="bg-gray-100 rounded-lg p-3 mt-3 text-left">
                <h1 className="text-xl font-semibold mb-1">
                  {convertDate(enrollDate)}
                </h1>
