...
import { useGetCourseContentQuery, useGetTeacherByEmailQuery, useUploadCourseContentMutation } from "../../../../../features/teacher/teacherApi";
    ...
    uploadCourseAsstesToFirebase(selectedFile, fileName)
      .then(async (url) => {
        ...
        const data = {
          semester: selectedSemester,
          courseCode: courseCode,
          lectures: { url, title: selectedFile.name },
        };
  ...
  return (
    <div>
      ...
      <form className="flex justify-end">
        ...
        <input
          name={`Course_Lecture_${courseCode}`}
          id="uploadFiles"
          className="hidden"
          type="file"
          onChange={(e) => {
      ...
      <div className="flex flex-col gap-3 mt-5">
        {courseContent?.data[0]?.lectures?.map((item, i) => (
          <div
...
export default TCourseLectures;
