...
const SingleStudentRow = ({ item, i, selectedSemester }) => {
  ...
  return (
    <tr key={item._id}>
      ...
      <td className="px-4 py-4 text-center text-sm text-gray-500 whitespace-nowrap">
        {isEditMode ? (
          <input
            ...
            className="w-16 p-2 text-gray-700 bg-white border border-gray-200 rounded-md focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring"
          />
        ) : (
      ...
      {/* <td className="px-4 py-4 text-center text-sm text-gray-500 whitespace-nowrap"></td> */}
      <td className="flex items-center justify-center px-4 py-4 text-center text-sm text-gray-500 whitespace-nowrap">
        {isEditMode ? (
