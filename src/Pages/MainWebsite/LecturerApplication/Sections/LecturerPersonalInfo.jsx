...
import { setPersonalInfo } from "../../../../features/application/lecturerApplicationSlice";

/* eslint-disable react/prop-types */
const LecturerPersonalInfo = () => {
  ...
  const {
    ...
    signature,
    address,
  } = useSelector((state) => state.lecturerApplication.personal);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const birth_date = moment(form.birth_date.value).format("MMMM Do YYYY");
      ...
      navigate("/applyforlecturer/online/educational");
    } catch (error) {
...
export default LecturerPersonalInfo;
