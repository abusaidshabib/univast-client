...
const Services = () => {
  return (
    <div className="services grid grid-cols-4 text-p-white bg-background-500 py-10">
      <div className="flex flex-col items-center gap-10 justify-center text-center p-10">
        ...
        <h3 className="text-2xl font-semibold font-serif tracking-wider">Admission</h3>
        <p>
      ...
      <div className="flex flex-col items-center gap-10 justify-center text-center p-10">
        ...
        <h3 className="text-2xl font-semibold font-serif tracking-wider">Programs</h3>
        <p>
      ...
      <div className="flex flex-col items-center gap-10 justify-center text-center p-10">
        ...
        <h3 className="text-2xl font-semibold font-serif tracking-wider">Tution Fees</h3>
        <p>
      ...
      <div className="flex flex-col items-center gap-10 justify-center text-center p-10">
        ...
        <h3 className="text-2xl font-semibold font-serif tracking-wider">Scholarship</h3>
        <p>
