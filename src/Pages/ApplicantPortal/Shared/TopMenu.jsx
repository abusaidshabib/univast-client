      ...
      <ul className="text-2xl flex gap-6 justify-end">
        <li>
          <Link className="relative">
            ...
            <span className="absolute animate-ping w-3 h-3 bg-setext-secondary-orange rounded-full -top-1 -right-1"></span>
            <span className="absolute w-3 h-3 bg-setext-secondary-orange rounded-full -top-1 -right-1"></span>
          </Link>
        </li>
        <li className="">
          <Link className="relative">
