  ...
  return (
    <div className="flex gap-10">
      <div>
        ...
        <button className="w-full bg-blue-200 py-2 font-medium">Reset Password</button>
      </div>
      <div className="flex-grow">
          <table className="text-lg">
            ...
            <tr className="p-5 border-y">
              <td className="py-3 text-right text-primary-gray">Admission Date:</td>
              <td className="py-3 pl-5">December 15, 2019</td>
            </tr>
            <tr className="p-5 border-y">
              <td className="py-3 text-right text-primary-gray">Student Status:</td>
            ...
            <tr className="p-5 border-y">
              <td className="py-3 text-right text-primary-gray">Completed Credit:</td>
