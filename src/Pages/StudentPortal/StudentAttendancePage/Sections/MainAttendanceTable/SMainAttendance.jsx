        ...
        <tbody>
          <tr>
            ...
            <td className="grid border border-gray-400">
              <Link
                className="p-2 w-full h-full bg-secondary-blue hover:bg-primary-blue text-center text-p-white"
                to="/student/attendance/singlePage"
              >
...
export default SMainAttendance;